"""
Generate Professional Gantt Chart for CN7021 Project
Based on project_planner_user_stories.csv
"""
...
def create_gantt_chart():
    # Define sprints and tasks based on project timeline
    ...
    # Remove y-axis labels (we have them on the left)
    ax.set_yticks([])
    ...
    # Save
    output_file = 'Gantt_Chart_School_Activity_Booking_System.png'
    ...
    print(f"🎨 Color-coded by team member")
    print(f"✅ Ready for insertion into Section 8 of report!")
