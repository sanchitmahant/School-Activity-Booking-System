...
## 1. Executive Summary
Centralizes all application configuration variables to ensure security and maintainability. Separates code from configuration data.
...
class Config:
    ...
    # Database
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'sqlite:///school_activities.db'
